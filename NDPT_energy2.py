...
# Return all non first/last-term-canceling partitions for correction n
...
class PartitionGenerator:
    ...
    def noncanceling_partitions(self, n):
        res = []
        # zero on each side
...
class MultiSet:
    ...
    def __hash__(self) -> int:
        return hash(set(self.items.items()))
